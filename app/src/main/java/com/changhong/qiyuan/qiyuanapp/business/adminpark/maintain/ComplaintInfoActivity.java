...
public class ComplaintInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busi_admp_complaint_info);
        m_context = this;
        re_items = (RecyclerView)findViewById(R.id.rv_busi_admp_complaint_infos);
        ...
        adapater.setOnItemClickListener(new myListAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                Intent intent=new Intent(ComplaintInfoActivity.this,ComplaintDetailActivity.class);
    ...
    private static class myListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            ...
            View view = LayoutInflater.from(context).inflate(R.layout.item_busi_admp_complaint, parent, false);
            ComplaintInfoActivity.myListAdapter.MyViewHolder holder = new ComplaintInfoActivity.myListAdapter.MyViewHolder(view);
            return holder;
        }
        ...
        public void onBindViewHolder(final RecyclerView.ViewHolder holder, int position) {
            if (holder instanceof ComplaintInfoActivity.myListAdapter.MyViewHolder) {
        ...
        class MyViewHolder extends RecyclerView.ViewHolder {
            ...
            MyViewHolder(View view) {
                super(view);
                tv_name = (TextView)view.findViewById(R.id.tv_item_busi_admp_complaint_name);
                tv_phone=(TextView)view.findViewById(R.id.tv_item_busi_admp_complaint_phone);
                tv_time=(TextView)view.findViewById(R.id.tv_item_busi_admp_complaint_time);
                iv_head = (ImageView)view.findViewById(R.id.iv_item_busi_admp_complaint_admin);
                tv_passornot=(TextView)view.findViewById(R.id.tv_item_busi_admp_complaint_passornot);
            }
        }
    }
}
