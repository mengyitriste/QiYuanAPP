...
public class ChooseCameraActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busi_monitor_choosecamera);
        m_context = this;
        ...
        toolbar_title.setText(this.getString(R.string.business_choose_camera));
        ...
        re_items = (RecyclerView)findViewById(R.id.rv_busi_monitor_cameras);
    ...
    private void initData() {
        ...
        char a='A';
        for (int i=0;i<5;i++){
            Data.camera.add("摄像头"+a);
            a++;
        }
        Data.find.clear();
        Data.find.addAll(Data.camera);
    }
