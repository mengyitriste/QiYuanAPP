...
public class SecondApplyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_busi_visitor_secondapply);
        ...
        icon_back_toolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SecondApplyActivity.this.finish();
            }
        });
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(SecondApplyActivity.this, SubmitDownActivity.class);
